...
def parallel_with_finally_example():
	...
	return awssl.StateMachine(
		Comment="A Parallel finally example, where the finally branch is executed both after successful completion, and before any Catchers are triggered when an error occurs",
		StartState=hello_world)

if __name__ == "__main__":
	sm = parallel_with_finally_example()
	print sm
